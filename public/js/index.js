...
var state = {
  ...
  function gameNewQuestion() {
    burgerOn();
    showHide(
      [gameContainer, burgerContainer, actualContainer, gameCorrectness],
...
////-------------
  ...
  function addlevel() {
    ...
    let borderWidth = window
      .getComputedStyle(trackerContainer2)
  ...
  async function updateProgress() {
    ...
    let borderWidth = window
      .getComputedStyle(trackerContainer)
      .getPropertyValue("border-width");
    fullWidth = parseFloat(fullWidth.slice(0, -2));
    borderWidth = parseFloat(borderWidth.slice(0, -2));
    fullWidth = fullWidth - borderWidth * 2;
